    ...
    <div className="pf-page">
      ...
      <div className="pf-shell" style={{ maxWidth: 560 }}>
        <header className="pf-head">
          <h1>Başlangıç ve Plus</h1>
          <p>
            Ücretsiz planda 1 kariyer sohbeti hakkın var. Plus ile ayda 5 ekstra sohbet turu açılır.
            Ödeme iyzico üzerinden (Troy / TL).
          </p>
        </header>
        ...
        {!ready ? (
          ...
          <React.Fragment>
            <div className="pw-plan-card">
              <h3>Başlangıç (Free)</h3>
              <ul>
                <li>1 tamamlanmış Kariyer Sohbeti</li>
                <li>Profil, yol haritası, pratikler ve check-in</li>
                <li>Kayıtlar silinmez — hak bitince de erişilir</li>
              </ul>
              <h3>Plus <span className="pw-price">Aylık</span></h3>
              <ul>
                <li>Ayda 5 ekstra sohbet turu</li>
                <li>CV boşluk analizi ve ilan uyumu</li>
                <li>Önceki vs şimdi yetkinlik karşılaştırması</li>
              </ul>
