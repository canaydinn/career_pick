...
(function () {
  const TR = {
    ...
    pricing: {
      ...
      plans: [
        {
          ...
          priceY: "₺0",
          period: "sonsuza dek",
          tagline: "Keşfetmeye başlamak için.",
          features: [
            "1 tamamlanmış Kariyer Sohbeti",
            "Profil, yol haritası ve pratikler",
            "Haftalık check-in",
          ],
          cta: "Ücretsiz başla",
          featured: false,
        },
        {
          ...
          priceY: "Aylık",
          period: "iyzico",
          tagline: "Ekstra sohbet ve derin analizler.",
          features: [
            "Başlangıç’taki her şey",
            "Ayda 5 ekstra sohbet turu",
            "CV boşluk analizi",
            "İlan uyumu analizi",
            "Yetkinlik karşılaştırması",
          ],
          cta: "Plus’a geç",
          featured: true,
        },
      ...
      faq: [
        { q: "Ücretsiz plan gerçekten ücretsiz mi?", a: "Evet. 1 kariyer sohbeti ve profil araçları ücretsizdir; kredi kartı istemez." },
        { q: "Plus ne sağlar?", a: "Ayda 5 ekstra sohbet turu, CV boşluk ve ilan uyumu analizleri." },
        { q: "İstediğim zaman iptal edebilir miyim?", a: "Evet. Profil sayfasından aboneliğini iptal edebilirsin; dönem sonuna kadar Plus kalır." },
        { q: "Ödeme nasıl alınır?", a: "iyzico Checkout Form ile; kart bilgisi CareerPick sunucusuna gelmez (Troy / TL)." },
      ],
    },
    changelog: {
      hero: {
  ...
  const EN = {
    ...
    pricing: {
      hero: { eyebrow: "Pricing", title: ["The easiest way to", "invest in your career"], sub: "Start free with 1 career chat. Upgrade to Plus for extra chats and deeper analysis." },
      toggle: { monthly: "Monthly", yearly: "Yearly", save: "Billed via iyzico" },
      plans: [
        {
          name: "Starter",
          priceM: "$0",
          priceY: "$0",
          period: "forever",
          tagline: "To start exploring.",
          features: ["1 completed Career Chat", "Profile, roadmap and practices", "Weekly check-in"],
          cta: "Start free",
          featured: false,
        },
        {
          ...
          priceY: "Monthly",
          period: "iyzico",
          tagline: "Extra chats and deeper analysis.",
          features: [
            "Everything in Starter",
            "5 extra chats per month",
            "CV gap analysis",
            "Job-fit analysis",
      ...
      faq: [
        { q: "Is the free plan really free?", a: "Yes. One career chat and profile tools are free — no credit card." },
        { q: "What does Plus include?", a: "5 extra chats per month, CV gap and job-fit analysis." },
        { q: "Can I cancel anytime?", a: "Yes. Cancel from your profile; Plus stays until period end." },
        { q: "How do I pay?", a: "Via iyzico Checkout Form; card data never hits CareerPick servers." },
      ],
    },
    changelog: {
